...
[▶ 下一頁]`,
  ...
  // ============================================================
  // 5-15：NodePort + 三種比較（5-15, 5-16, 5-17）
  // ============================================================
...
[▶ 下一頁]`,
  ...
  // ============================================================
  // 5-17：CoreDNS + Namespace（5-18, 5-19, 5-20）
  // ============================================================
  ...
  // ── 5-18 概念（1/2）：DNS 服務發現 ──
  {
    ...
    section: '5-17：CoreDNS + Namespace',
    duration: '8',
    content: (
      <div className="space-y-4">
        <div className="bg-slate-900/60 border border-slate-700 p-4 rounded-lg">
...
[▶ 下一頁]`,
  ...
  // ── 5-19 學員實作 ──
  {
    ...
    code: `# 學員實作 5-17：CoreDNS + Namespace
kubectl create namespace dev
...
[▶ 下一頁]`,
  ...
  // ============================================================
  // 5-18：DaemonSet + CronJob（5-21, 5-22, 5-23）
  // ============================================================
  ...
  // ── 5-21 概念（1/2）：DaemonSet ──
  {
    ...
    section: '5-18：DaemonSet + CronJob',
    duration: '8',
    content: (
      <div className="space-y-4">
        <div className="bg-slate-900/60 border border-slate-700 p-4 rounded-lg">
