...
### 📄 第 1 張：Pod IP 三大問題 → Service 解法（8 min）
...
### 📄 第 2 張：ClusterIP Service 原理（8 min）
...
### 📄 第 3 張：Lab：建立 ClusterIP Service（8 min）
...
### 📄 第 4 張：學員實作：ClusterIP Service（10 min）

> 📋 學生看 PPT 投影片，上面有完整說明。

---

### 📄 第 5 張：ClusterIP 排錯 + 常見坑（5 min）
...
### 📄 第 6 張：Lab 4：API 連線中斷，找出 Bug 並修復（15 min）
...
### 📄 第 9 張：Lab：建立 NodePort Service（8 min）
...
### 📄 第 10 張：學員實作：NodePort Service（10 min）

> 📋 學生看 PPT 投影片，上面有完整說明。

---

### 📄 第 11 張：NodePort 排錯 + Loop 4-5 小結（5 min）
...
### 📄 第 12 張：Lab 5：老闆說從外面連不到，找出兩個 Bug（15 min）
...
### 📄 第 14 張：Namespace -- 叢集裡的資料夾（7 min）
...
### 📄 第 16 張：Lab：DNS 驗證 + Namespace 實作（8 min）
...
### 📄 第 17 張：學員實作：DNS + Namespace（10 min）

> 📋 學生看 PPT 投影片，上面有完整說明。

---

### 📄 第 18 張：DNS + Namespace 常見坑（5 min）
...
### 📄 第 19 張：Lab 6：跨團隊連線失敗，改用 FQDN 完成連線（15 min）
