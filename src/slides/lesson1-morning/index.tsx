    ...
    content: (
      <div className="grid gap-4">
        {[
          ...
          { time: "10:00-10:30", topic: "Linux vs Windows 差異比較", icon: "⚔️" },          { time: "10:30-11:15", topic: "Linux 核心概念與發行版", icon: "🐧" },
          { time: "11:15-12:00", topic: "實作：第一次登入 Linux", icon: "💻" },
        ].map((item, i) => (
...
10:30 到 11:15 進入 Linux 的核心概念，包括檔案系統結構和使用者權限。

最後 11:15 到 12:00 是實作時間，讓每個人親自動手，用 SSH 登入一台真正的 Linux 主機。這是最重要的環節！整個上午的安排都是循序漸進的，有問題隨時提出來。
