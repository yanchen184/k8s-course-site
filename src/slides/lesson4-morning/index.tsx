...
但是這裡我要特別講清楚一件事，很多人會搞錯：Base64 是編碼，不是加密。加密是用金鑰把資料鎖起來，沒有金鑰打不開。Base64 只是一種轉換格式，就像把中文翻譯成英文，任何人都能翻回來。你拿到一個 Base64 字串，終端機裡執行一個 base64 decode 指令，一秒鐘就解回原文了。所以千萬不要以為放進 Secret 就安全了。
    ...
    content: (
      <div className="space-y-4">
        <div className="bg-green-900/30 border border-green-500/30 p-3 rounded-lg">
          ...
          <code className="text-cyan-400 text-sm">kubectl create deployment nginx --replicas=3</code>
