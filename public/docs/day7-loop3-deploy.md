...
▶ **PPT 5/45：修復 worker NotReady（IP 飄移）**
...
▶ **PPT 11/45：ConfigMap 說明 — 為什麼是 Service 名稱**
...
▶ **PPT 12/45：PostgreSQL — 為什麼不用 Deployment**
...
▶ **PPT 14/45：PostgreSQL StatefulSet YAML**
...
▶ **PPT 18/45：第二段過場 — 資料層（04~07）**

### 第二段：資料層（04~07）

---

▶ **PPT 19/45：Redis — 為什麼用 Deployment**
...
▶ **PPT 21/45：Job — 一次性 DB Migration YAML**
...
▶ **PPT 23/45：RBAC — Backend 最小權限 YAML**
...
▶ **PPT 25/45：Backend Deployment + Service YAML**
...
▶ **PPT 29/45：第三段過場 — 應用層（08~12）**

### 第三段：應用層（08~12）

---

▶ **PPT 30/45：Frontend Deployment + Service**
...
▶ **PPT 31/45：Task Runner — 為什麼沒有 Service**
...
▶ **PPT 32/45：Task Runner — 為什麼不是 DaemonSet**
...
▶ **PPT 33/45：Task Runner Deployment YAML**
...
▶ **PPT 36/45：concurrencyPolicy 三選項**
...
▶ **PPT 37/45：Ingress — k3s 用 Traefik**
