    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-blue-900/30 border border-blue-500/30 p-3 rounded-lg">
          ...
          <p className="text-slate-300 text-xs">想把 Secret YAML 放進 Git？Base64 一解碼密碼就曝光。<strong className="text-white">Sealed Secret</strong> 用 RSA 非對稱加密，只有叢集裡的 controller 有私鑰能解密。GitOps 團隊必備。課程不深入，知道有就好。</p>
        </div>
