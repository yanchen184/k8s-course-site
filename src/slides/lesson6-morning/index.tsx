...
[▶ 下一頁]`,
  ...
  {
    title: '今天的 Demo App：jasonmel/k8s-demo-app',
    ...
    code: `# 直接跑看看效果
kubectl run demo --image=jasonmel/k8s-demo-app:latest \\
...
這個 app 叫做 jasonmel/k8s-demo-app。它就是一個很簡單的 PHP 應用，收到 HTTP 請求，就把自己的狀態印出來。印四行：Server 是自己的 IP 和 Pod 名稱，Message 是 MESSAGE 這個環境變數的值，Username 是 USERNAME 的值，Password 是 PASSWORD 的值。
